...
class Dashboard_model extends CI_Model{
    ...
    public function complain_data($fdate, $ldate){
        $false_val = 0;
    ...
    public function solved_data($fdate, $ldate){
        $false_val = 0;
       $this->db->select('COUNT(id) as id');
        $this->db->from('cc_requisition_data');
    ...
    public function solved_date($fdate, $ldate){
        $false_val = 0;
    ...
    public function deviation_date($fdate, $ldate){
        $false_val = 0;
    ...
    public function income_data($fdate, $ldate){
    ...
    public function total_value($fdate, $ldate){
        $false_val = 0;
    ...
    public function total_repari_value($fdate, $ldate){
         $false_val = 0;
        $this->db->select('SUM(cc_product.price) as price');
        $this->db->from('cc_requisition_data');
        $this->db->join('cc_product', 'cc_product.id = cc_requisition_data.product_id');
    ...
    public function total_repari_cost($fdate, $ldate){
        $false_val = 0;
