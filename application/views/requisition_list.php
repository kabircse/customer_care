                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li><a href="<?php echo base_url() . 'customerCare/editRequisition/'.$requisitionList['rqtn_id'];?>">Edit</a></li>
                                                            ...
                                                            <li><a href="<?php echo base_url().'customerCare/deleteRequisition/'.$requisitionList['rqtn_id'];?>" onclick="return confirm('Are you sure???')">Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
