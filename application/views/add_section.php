                    ...
                    <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <form class="smart-form" method="post" action="<?php echo base_url() . 'creation/insertSection' ?>">
                    ...
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <form class="smart-form" method="post" action="<?php echo base_url() . 'creation/updateSection' ?>">
                                            <div class="table-responsive">
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="width: 50%">
                                                                <label class="select" name="parent_category">
                                                                    <select class="parent_category" name="section_id">
                                        ...
                                        <tbody>
                                            ...
                                            if ($sectionlist) {
                                                ...
                                                foreach ($sectionlist as $sectionName) {
                                                    ...
                                                    <tr>
                                                        <td><?php echo $sectionName['name']; ?></td>
                                                        <td>
                                                            <a href="<?php echo base_url() . 'creation/deleteSection/' . $sectionName['id'] ?>" onclick="return confirm('Are You Sure?????')" class="btn btn-xs btn-danger">Delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
