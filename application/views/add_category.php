                    ...
                    <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <form class="smart-form" method="post" action="<?php echo base_url() . 'product/insertCategory' ?>">
                                            ...
                                            if (isset($categories) && $categories) {
                                                foreach ($categories as $category) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url() . 'product/editCategory/' . $category['id'] ?>" class="btn btn-xs btn-warning">Edit</a>
                                                            <a href="<?php echo base_url() . 'product/deleteCategory/' . $category['id'] ?>" class="btn btn-xs btn-danger">Delete</a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
