...
<html lang="en-us">
    <head>
        ...
        <!-- FAVICONS -->
        <link rel="shortcut icon" href="<?php echo base_url()?>favicon/favicon.ico" type="image/x-icon">
        <link rel="icon" href="<?php echo base_url()?>favicon/favicon.ico" type="image/x-icon">
                    ...
                    <div class="col-xs-12 col-md-offset-4 col-sm-12 col-md-5 col-lg-4">
                        <div class="well no-padding">
                            <form action="<?php echo base_url().'login/check_login'?>" id="login-form" class="smart-form client-form" method="post">
                                ...
                                <div class="error-container1 text-danger"> <?php echo $this->session->flashdata('disable'); ?></div>
                                </fieldset>
