                    ...
                    <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <form class="smart-form" method="post" action="<?php echo base_url() . 'creation/insertProblem' ?>">
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 50%">
                                                                <label class="input">
                                                                    <input type="text" placeholder="Enter Problem Name" name="name" value="<?php echo set_value('name'); ?>">
                                                                </label>
                                                            </td>
                    ...
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <form class="smart-form" method="post" action="<?php echo base_url() . 'creation/updateProblem' ?>">
                                            <div class="table-responsive">
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="width: 30%"><span class="text-danger"><?php echo form_error('problem_id'); ?></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 20%">Problem Name</td>
                                                            <td style="width: 50%">
                                                                <label class="input">
                                                                    <input type="text" placeholder="Enter Problem Name" name="new_name" value="<?php echo set_value('new_name'); ?>">
                                                                </label>
                                                            </td>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            if ($problemlist) {
                                                ...
                                                foreach ($problemlist as $problemName) {
                                                    //print_r($colorname);
                                                    ?>

                                                    <tr>
                                                        <td><?php echo $problemName['name']; ?></td>
                                                        <td>
                                                            <a href="<?php echo base_url() . 'creation/deleteProblem/' . $problemName['id'] ?>" onclick="return confirm('Are You Sure?????')" class="btn btn-xs btn-danger">Delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
