                                            ...
                                            if ($requisition) {
                                                foreach ($requisition as $info) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <ul class="list-unstyled list-inline" style="width:165px;">
                                                                <li><a href="<?php echo base_url() . 'customerCare/editRequisitionProduct/'.$info['data_id'] ?>" class="btn btn-xs btn-warning">Edit</a></li>
                                                                <li><a href="<?php echo base_url() . 'customerCare/allocateExpense/'.$info['data_id'] ?>" class="btn btn-xs btn-warning">Allocate Expense</a></li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                    <?php
